System.register(['react', 'mobx', 'jb-modules/DateTimeModule/dist/DateTimeConverter.cjs.min', 'mobx-react'], function (exports, module) {
    'use strict';
    var React, extendObservable, observable, observe, DateTimeConverter, observer;
    return {
        setters: [function (module) {
            React = module.default;
        }, function (module) {
            extendObservable = module.extendObservable;
            observable = module.observable;
            observe = module.observe;
        }, function (module) {
            DateTimeConverter = module.default;
        }, function (module) {
        ...
        execute: function () {
            ...
            function () {
              function JBDateInputService(props) {
                ...
                var disposer = observe(this.componentStatus, function (change) {
            ...
            }(), _temp), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "componentStatus", [observable], {
              configurable: true,
              enumerable: true,
              writable: true,
            ...
            }), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "elements", [observable], {
              configurable: true,
              enumerable: true,
              writable: true,
              initializer: function initializer() {
            ...
            }), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "defaultConfig", [observable], {
              configurable: true,
              enumerable: true,
              writable: true,
              initializer: function initializer() {
            ...
            var JBDateInput = observer(_class$1 =
